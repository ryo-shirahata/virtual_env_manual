...
## 以下よりホストOSサイドの操作になります
現在ログイン中の方は一度ログアウトしましょう。
```
exit
```
ホスト・ゲスト何方のOSで操作するかによって

大変大きな問題が生じる場合があります。

この段階から現在は何方で作業をしているのか意識しましょう。
...
## LEMP環境
**LEMP環境** とは、Webアプリケーションを開発するための、代表的なシステムの頭文字を取って命名されています。
...
Nginxなので *LNMP* としたくなるところですが、

nginx→エンジンエックス→Engine-X という流れから至るようです。

また、他にも LAMP や XAMPP や MAMP といった環境構築パッケージもあります。
